...
namespace PROYECTOIS1
{
    public partial class Punto_de_Venta : Form
    {
        ...
        private void ButtonAgregar_Click(object sender, EventArgs e)
        {
            ...
            }//Obtencion del numero del ticket
            {
                try
                {
                    ...
                    int BD_idProducto = int.Parse(textBoxCodigoProducto.Text);
                    double BD_peso = double.Parse(textBoxPeso.Text);
        ...
        private void ButtonCorte_Click(object sender, EventArgs e)
        {
        ...
        private void ButtonCanProd_Click(object sender, EventArgs e)
        {
